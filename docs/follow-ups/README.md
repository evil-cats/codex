...
| [follow-up:FU-2026-006] | `accepted` | Настраиваемые размеры TUI history image preview | перед следующим этапом TUI history image preview sizing | [feature:tui-history-image-previews], [code:view-image-handler], [code:pets-mod] |
...
[follow-up:FU-2026-006]: FU-2026-006-tui-history-image-preview-size.md
