...
| [follow-up:FU-2026-006] | `preview_size` и config rows реализованы | [archive:FU-2026-006] | TUI history previews поддерживают `small` / `normal` / `large` через trusted path |
...
[archive:FU-2026-006]: archive/2026/FU-2026-006-tui-history-image-preview-size.md
...
[follow-up:FU-2026-006]: archive/2026/FU-2026-006-tui-history-image-preview-size.md
