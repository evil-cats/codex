...
use codex_core_api::HistoryImagePreviewConfig;
...
fn new_config(model: Option<String>, arg0_paths: Arg0DispatchPaths) -> anyhow::Result<Config> {
    ...
    let mut config = Config {
        ...
        exec_inline_output_max_tokens: 1_000,
        read_file_content_max_tokens: 10_000,
        agents_enabled: true,
        ...
        get_system_time_enabled: true,
        get_thread_info_enabled: true,
        update_plan_enabled: true,
        tool_registry: Default::default(),
        code_mode: Default::default(),
        background_terminal_wait_timeout_ms: 60_000,
