...
- `yield_time_ms` is the watchdog timeout; if omitted, the configured tool default applies.
- Cell completion, explicit `yield_control()`, or new user input returns sooner without stopping a live cell.
