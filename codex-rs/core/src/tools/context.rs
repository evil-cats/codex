...
impl ExecCommandToolOutput {
    ...
    fn response_metadata(&self) -> Vec<String> {
    ...
    fn response_header(&self) -> String {
        let mut sections = self.response_metadata();
    ...
    fn response_text(&self) -> String {
        ...
        // История применяет тот же лимит сериализации ко всему ответу. Резервируем место для
        // метаданных, предупреждений и маркера, чтобы не усекать уже сокращённый вывод повторно.
