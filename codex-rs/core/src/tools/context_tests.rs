...
/// Ответ модели остаётся ограниченным, а журнал телеметрии содержит полный захваченный вывод.
#[test]
...
/// Общий лимит ответа резервирует метаданные и сохраняет единицы исходной политики усечения.
#[test]
...
/// Ответ модели и журнал телеметрии сохраняют маркер пропущенных байтов capture-слоя ровно один раз.
#[test]
