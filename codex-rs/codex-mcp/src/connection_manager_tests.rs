//! Проверяет startup, согласование, каталог и жизненный цикл набора MCP-соединений.
...
impl McpConnectionSet {
    /// Создаёт пустой набор соединений для тестов, не запускающий MCP-клиенты.
    fn new_uninitialized(
        ...
        Self {
            ...
            reused_pending_startup_outcome: tokio::sync::watch::channel(
