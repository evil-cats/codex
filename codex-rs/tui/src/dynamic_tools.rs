                            ...
                            let latest_tool_marker = latest_turn
                                ...
                                .and_then(|(turn, items)| {
                                    ...
                                    ThreadItem::CoreToolActivity {
                                        ...
                                        "id": id, "turnId": turn.id, "type": "coreToolActivity",
                                        "name": tool_name, "status": status
                                    })),
    ...
    let mut items: Vec<Value> = turn
        ...
        .map(|item| match item {
            ...
            ThreadItem::CoreToolActivity {
                ...
                "type": "coreToolActivity", "id": id, "toolName": tool_name,
                "kind": kind, "detail": detail, "arguments": arguments,
                "status": status, "error": error, "durationMs": duration_ms
            }),
            ThreadItem::CollabAgentToolCall {
                id,
                tool,
            ...
            ThreadItem::ImageView {
                ...
                "type": "imageView", "id": id, "path": path, "previewSize": preview_size
            }),
