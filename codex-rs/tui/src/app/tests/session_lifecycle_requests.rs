...
/// Создаёт многостраничный rollout и проверяет единственное построение
/// ожидаемого visualization context за всю начальную hydration.
...
/// Доступный visualization context переиспользуется между страницами items.
...
/// Отсутствующий visualization context также не вычисляется повторно между страницами.
#[tokio::test(flavor = "current_thread")]
