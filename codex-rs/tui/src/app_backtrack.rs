...
impl App {
    ...
    fn sync_overlay_after_transcript_trim(&mut self) {
        ...
        // While overlay is open, we buffer rendered history items and flush them on close.
        // If rollback trimmed cells meanwhile, those buffered items can reference removed turns.
